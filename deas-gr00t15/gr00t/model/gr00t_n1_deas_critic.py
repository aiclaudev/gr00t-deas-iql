    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        if not from_gr00t_n1_5:
            ...
            critic_head_cfg.critic_config = critic_cfg or {}
            critic_head_cfg.value_config = value_cfg
            critic_head_cfg.rl_config = rl_cfg
            # Fresh critics use one shared feature representation for Q/V/target-Q.
            # Persist the marker so evaluation can distinguish legacy checkpoints.
            critic_head_cfg.online_q_feature_passes = 1
