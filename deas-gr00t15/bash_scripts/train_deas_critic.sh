...
RUN_NAME=DEAS_Critic_as${CRITIC_ACTION_HORIZON}_e${EXPECTILE}_d1${DISCOUNT1}_d2${DISCOUNT2}_bs${TOTAL_BATCH_SIZE}_steps${STEPS}
script="
    WANDB_PROJECT='gr00t1.5 finetune' WANDB_ENTITY=aiclaudev WANDB_MODE=online \
